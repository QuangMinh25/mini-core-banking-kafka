...
- Current source package present:
  - `src/main/java/com/minh/bankingcore`
- Current test package present:
  - `src/test/java/com/minh/bankingcore`
...
- Application bootstrap: `src/main/java/com/minh/bankingcore/BankingCoreServiceApplication.java`
- Test bootstrap: `src/test/java/com/minh/bankingcore/BankingCoreServiceApplicationTests.java`
...
- Treat all future banking-domain data as sensitive
...
- HTTP integrations beyond Spring MVC capability: `Unknown / needs confirmation`
