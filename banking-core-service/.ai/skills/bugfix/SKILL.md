...
Use for correcting an existing defect in `banking-core-service` with the smallest safe behavior change.
...
- Assuming missing banking logic exists somewhere unseen
