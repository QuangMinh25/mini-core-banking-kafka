...
MCP tools may be used to inspect repository context, read GitLab metadata, inspect local or development PostgreSQL schema, and assist with safe verification or analysis tasks for `banking-core-service`.
...
- Banking, customer, account, transaction, and audit data must be treated as sensitive
