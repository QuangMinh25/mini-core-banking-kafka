...
Review final changes in `banking-core-service` for correctness, scope control, and operational risk.
...
- Cross-service impact on `notification-service` when relevant
