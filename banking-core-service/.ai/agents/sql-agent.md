...
Guide PostgreSQL, JPA-query, and Flyway-adjacent work for `banking-core-service` with a strong bias toward correctness and read-only investigation.
...
- Safety around any future banking ledger or transaction tables
