...
Use for runtime exceptions, wrong results, startup failures, Kafka-flow issues, PostgreSQL/JPA issues, validation bugs, or environment-specific defects in `notification-service`.
