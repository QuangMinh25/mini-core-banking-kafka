...
Use for tracing request or event flow, improving observability, or investigating slow behavior in `notification-service`.

## Goal

Add only useful evidence, preserve behavior, and avoid leaking sensitive notification-domain data.
...
- Never log secrets, credentials, tokens, connection strings, or full sensitive message payloads
