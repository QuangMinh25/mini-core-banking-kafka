...
Lead scope, boundary, and design analysis for this Spring Boot service and any coordination with the sibling `banking-core-service`.

## Responsibilities

- Identify whether the task is local to `notification-service` or cross-service
