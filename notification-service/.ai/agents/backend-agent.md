...
Handle Java and Spring Boot implementation work for `notification-service`, including Web MVC, validation, JPA/Flyway-adjacent code, and Kafka integration code when present.

## Responsibilities

- Implement or adjust backend behavior safely
- Preserve validation, exception handling, and transaction semantics
- Respect existing package conventions in `com.minh.notification`
...
- Compatibility with the sibling banking flow when the task spans both services
