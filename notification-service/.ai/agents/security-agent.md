...
Protect sensitive notification-domain behavior, secrets, access boundaries, auditability, and safe tool usage for `notification-service`.

## Responsibilities

- Review recipient, message-content, template, and delivery-status changes as high risk
