...
- Risks:
  - Treating inferred notification behavior as fact
  - Missing cross-service context when the issue spans `banking-core-service`
...
- Risks:
  ...
  - Creating undocumented coupling to `banking-core-service`
...
- Risks:
  ...
  - Logging sensitive or future recipient/message data
...
- Risks:
  ...
  - Exposing recipient or message data in logs, prompts, or MCP output
